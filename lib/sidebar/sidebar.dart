...
String yearClass6ATitle = "Year 6A Class Graduates";
String yearClass6BTitle = "Year 6B Class Graduates";
String yearClass6CTitle = "Year 6C Class Graduates";
                            ...
                            Material(
                              ...
                              child: InkWell(
                                ...
                                onTap: () {
                                  _onSelected(0);
                                  onIconPressed();
                                  BlocProvider.of<NavigationBloc>(context).add(NavigationEvents.MyYear6ClassAPageClickedEvent);
                                },
                                child: Align(
                                  alignment: Alignment.centerLeft,
                                  child: MenuItem(
                                    icon: MdiIcons.matrix,
                                    title: yearClass6ATitle,
                            ...
                            Material(
                              ...
                              child: InkWell(
                                ...
                                onTap: () {
                                  _onSelected(1);
                                  onIconPressed();
                                  BlocProvider.of<NavigationBloc>(context).add(NavigationEvents.MyYear6ClassBPageClickedEvent);
                                },
                                child: Align(
                                  alignment: Alignment.centerLeft,
                                  child: MenuItem(
                                    icon: MdiIcons.chartBellCurve,
                                    title: yearClass6BTitle,
                                  ),
                                ),
                              ),
                            ),
                            Material(
                              ...
                              child: InkWell(
                                ...
                                onTap: () {
                                  _onSelected(2);
                                  onIconPressed();
                                  BlocProvider.of<NavigationBloc>(context).add(NavigationEvents.MyYear6ClassCPageClickedEvent);
                                },
                                child: Align(
                                  alignment: Alignment.centerLeft,
                                  child: MenuItem(
                                    icon: MdiIcons.draw,
                                    title: yearClass6CTitle,
                                  ),
                                ),
                              ),
                            ),

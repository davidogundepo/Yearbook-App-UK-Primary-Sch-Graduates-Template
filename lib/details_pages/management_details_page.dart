...
Color backgroundColor = Color.fromRGBO(6, 44, 48, 1);
Color appBarTextColor = Colors.white;
Color appBarBackgroundColor = Color.fromRGBO(6, 44, 48, 1);
Color appBarIconColor = Colors.white;
Color materialBackgroundColor = Colors.transparent;
Color shapeDecorationColor = Color.fromRGBO(6, 44, 48, 1);
Color shapeDecorationColorTwo = Color.fromRGBO(6, 44, 48, 1);
Color shapeDecorationTextColor = Color.fromRGBO(6, 44, 48, 1);
Color shapeDecorationIconColor = Color.fromRGBO(6, 44, 48, 1);
Color cardBackgroundColor = Colors.white;
Color splashColor = Color.fromRGBO(6, 44, 48, 1);
Color splashColorTwo = Colors.white;
Color splashColorThree = Color.fromRGBO(6, 44, 48, 1);
Color iconTextColor = Colors.white;
Color buttonColor = Color.fromRGBO(6, 44, 48, 1);
Color textColor = Color.fromRGBO(6, 44, 48, 1);

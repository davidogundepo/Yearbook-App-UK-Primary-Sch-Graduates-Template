...
Color backgroundColor = Color.fromRGBO(27, 32, 33, 1);
Color appBarTextColor = Colors.white;
Color appBarBackgroundColor = Color.fromRGBO(27, 32, 33, 1);
Color appBarIconColor = Colors.white;
Color materialBackgroundColor = Colors.transparent;
Color shapeDecorationColor = Color.fromRGBO(27, 32, 33, 1);
Color shapeDecorationColorTwo = Colors.white;
Color shapeDecorationColorThree = Color.fromRGBO(27, 32, 33, 1);
Color shapeDecorationTextColor = Color.fromRGBO(27, 32, 33, 1);
Color shapeDecorationIconColor = Color.fromRGBO(27, 32, 33, 1);
Color cardBackgroundColor = Colors.white;
Color splashColor = Color.fromRGBO(27, 32, 33, 1);
Color splashColorTwo = Colors.white;
Color splashColorThree = Color.fromRGBO(27, 32, 33, 1);
Color iconTextColor = Colors.white;
Color iconTextColorTwo = Color.fromRGBO(27, 32, 33, 1);
Color buttonColor = Color.fromRGBO(27, 32, 33, 1);
Color textColor = Color.fromRGBO(27, 32, 33, 1);
...
PrimarySchoolGraduatingClassBNotifier primarySchoolGraduatingClassBNotifier;
...
class _SubPageState extends State<SubPage> {
  ...
  Widget build(BuildContext context) {
    primarySchoolGraduatingClassBNotifier =
        Provider.of<PrimarySchoolGraduatingClassBNotifier>(context, listen: true);
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(
            primarySchoolGraduatingClassBNotifier.currentPrimarySchoolGraduatingClassB.nickname,
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: primarySchoolGraduatingClassBNotifier.currentPrimarySchoolGraduatingClassB.image,
                        fit: BoxFit.cover,
                  ...
                  message: primarySchoolGraduatingClassBNotifier.currentPrimarySchoolGraduatingClassB.name),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              primarySchoolGraduatingClassBNotifier.currentPrimarySchoolGraduatingClassB.name.toUpperCase(),
                            ...
                            (() {
                              if (primarySchoolGraduatingClassBNotifier.currentPrimarySchoolGraduatingClassB.prefect == "Yes") {
                                return
                                  Row(
                                    children: <Widget>[
                                      SizedBox(width: 10),
  ...
  initState() {
    ...
    PrimarySchoolGraduatingClassBNotifier primarySchoolGraduatingClassBNotifier = Provider.of<PrimarySchoolGraduatingClassBNotifier>(context, listen: false);

    _autoBio = primarySchoolGraduatingClassBNotifier.currentPrimarySchoolGraduatingClassB.autoBio;
    _bestMoment = primarySchoolGraduatingClassBNotifier.currentPrimarySchoolGraduatingClassB.bestMoment;
    _dob = primarySchoolGraduatingClassBNotifier.currentPrimarySchoolGraduatingClassB.dob;
    _dreamSecondarySchool = primarySchoolGraduatingClassBNotifier.currentPrimarySchoolGraduatingClassB.dreamSecondarySchool;
    _dreamUniversity = primarySchoolGraduatingClassBNotifier.currentPrimarySchoolGraduatingClassB.dreamUniversity;
    _facebook = primarySchoolGraduatingClassBNotifier.currentPrimarySchoolGraduatingClassB.facebook;
    _hobbies = primarySchoolGraduatingClassBNotifier.currentPrimarySchoolGraduatingClassB.hobbies;
    _instagram = primarySchoolGraduatingClassBNotifier.currentPrimarySchoolGraduatingClassB.instagram;
    _myDropline = primarySchoolGraduatingClassBNotifier.currentPrimarySchoolGraduatingClassB.myDropline;
    _nickname = primarySchoolGraduatingClassBNotifier.currentPrimarySchoolGraduatingClassB.nickname;
    _philosophy = primarySchoolGraduatingClassBNotifier.currentPrimarySchoolGraduatingClassB.philosophy;
    _prefect = primarySchoolGraduatingClassBNotifier.currentPrimarySchoolGraduatingClassB.prefect;
    _prefectPosition = primarySchoolGraduatingClassBNotifier.currentPrimarySchoolGraduatingClassB.positionEnforced;
    _country = primarySchoolGraduatingClassBNotifier.currentPrimarySchoolGraduatingClassB.constituentCountry;
    _regionFrom = primarySchoolGraduatingClassBNotifier.currentPrimarySchoolGraduatingClassB.regionFrom;
    _favSport = primarySchoolGraduatingClassBNotifier.currentPrimarySchoolGraduatingClassB.favSport;
    _snapchat = primarySchoolGraduatingClassBNotifier.currentPrimarySchoolGraduatingClassB.snapchat;
    _tikTok = primarySchoolGraduatingClassBNotifier.currentPrimarySchoolGraduatingClassB.tikTok;
    _favSubject = primarySchoolGraduatingClassBNotifier.currentPrimarySchoolGraduatingClassB.favSubject;
    _favSchoolActivity = primarySchoolGraduatingClassBNotifier.currentPrimarySchoolGraduatingClassB.favSchoolActivity;
    _favClassmate = primarySchoolGraduatingClassBNotifier.currentPrimarySchoolGraduatingClassB.favClassmate;
    _favPlaceInCampus = primarySchoolGraduatingClassBNotifier.currentPrimarySchoolGraduatingClassB.favPlaceInCampus;
    _favTVStation = primarySchoolGraduatingClassBNotifier.currentPrimarySchoolGraduatingClassB.favTVStation;
    _favCartoon = primarySchoolGraduatingClassBNotifier.currentPrimarySchoolGraduatingClassB.favCartoon;
    _worstMoment = primarySchoolGraduatingClassBNotifier.currentPrimarySchoolGraduatingClassB.worstMoment;

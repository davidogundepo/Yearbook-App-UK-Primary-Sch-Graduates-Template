...
Color backgroundColor = Color.fromRGBO(216, 172, 156, 1);
Color appBarTextColor = Colors.white;
Color appBarBackgroundColor = Color.fromRGBO(216, 172, 156, 1);
Color appBarIconColor = Colors.white;
Color materialBackgroundColor = Colors.transparent;
Color shapeDecorationColor = Color.fromRGBO(216, 172, 156, 1);
Color shapeDecorationColorTwo = Colors.white;
Color shapeDecorationColorThree = Color.fromRGBO(216, 172, 156, 1);
Color shapeDecorationTextColor = Color.fromRGBO(216, 172, 156, 1);
Color shapeDecorationIconColor = Color.fromRGBO(216, 172, 156, 1);
Color cardBackgroundColor = Colors.white;
Color splashColor = Color.fromRGBO(216, 172, 156, 1);
Color splashColorTwo = Colors.white;
Color splashColorThree = Color.fromRGBO(216, 172, 156, 1);
Color iconTextColor = Colors.white;
Color iconTextColorTwo = Color.fromRGBO(216, 172, 156, 1);
Color buttonColor = Color.fromRGBO(216, 172, 156, 1);
Color textColor = Color.fromRGBO(216, 172, 156, 1);
...
PrimarySchoolGraduatingClassANotifier primarySchoolGraduatingClassANotifier;
...
class _SubPageState extends State<SubPage> {
  ...
  Widget build(BuildContext context) {
    primarySchoolGraduatingClassANotifier =
        Provider.of<PrimarySchoolGraduatingClassANotifier>(context, listen: true);
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(
            primarySchoolGraduatingClassANotifier.currentPrimarySchoolGraduatingClassA.nickname,
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: primarySchoolGraduatingClassANotifier.currentPrimarySchoolGraduatingClassA.image,
                        fit: BoxFit.cover,
                  ...
                  message: primarySchoolGraduatingClassANotifier.currentPrimarySchoolGraduatingClassA.name),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              primarySchoolGraduatingClassANotifier.currentPrimarySchoolGraduatingClassA.name.toUpperCase(),
                            ...
                            (() {
                              if (primarySchoolGraduatingClassANotifier.currentPrimarySchoolGraduatingClassA.prefect == "Yes") {
                                return
                                  Row(
                                    children: <Widget>[
                                      SizedBox(width: 10),
  ...
  initState() {
    ...
    _autoBio = primarySchoolGraduatingClassANotifier.currentPrimarySchoolGraduatingClassA.autoBio;
    _bestMoment = primarySchoolGraduatingClassANotifier.currentPrimarySchoolGraduatingClassA.bestMoment;
    _dob = primarySchoolGraduatingClassANotifier.currentPrimarySchoolGraduatingClassA.dob;
    _dreamSecondarySchool = primarySchoolGraduatingClassANotifier.currentPrimarySchoolGraduatingClassA.dreamSecondarySchool;
    _dreamUniversity = primarySchoolGraduatingClassANotifier.currentPrimarySchoolGraduatingClassA.dreamUniversity;
    _facebook = primarySchoolGraduatingClassANotifier.currentPrimarySchoolGraduatingClassA.facebook;
    _hobbies = primarySchoolGraduatingClassANotifier.currentPrimarySchoolGraduatingClassA.hobbies;
    _instagram = primarySchoolGraduatingClassANotifier.currentPrimarySchoolGraduatingClassA.instagram;
    _myDropline = primarySchoolGraduatingClassANotifier.currentPrimarySchoolGraduatingClassA.myDropline;
    _nickname = primarySchoolGraduatingClassANotifier.currentPrimarySchoolGraduatingClassA.nickname;
    _philosophy = primarySchoolGraduatingClassANotifier.currentPrimarySchoolGraduatingClassA.philosophy;
    _prefect = primarySchoolGraduatingClassANotifier.currentPrimarySchoolGraduatingClassA.prefect;
    _prefectPosition = primarySchoolGraduatingClassANotifier.currentPrimarySchoolGraduatingClassA.positionEnforced;
    _country = primarySchoolGraduatingClassANotifier.currentPrimarySchoolGraduatingClassA.constituentCountry;
    _regionFrom = primarySchoolGraduatingClassANotifier.currentPrimarySchoolGraduatingClassA.regionFrom;
    _favSport = primarySchoolGraduatingClassANotifier.currentPrimarySchoolGraduatingClassA.favSport;
    _snapchat = primarySchoolGraduatingClassANotifier.currentPrimarySchoolGraduatingClassA.snapchat;
    _tikTok = primarySchoolGraduatingClassANotifier.currentPrimarySchoolGraduatingClassA.tikTok;
    _favSubject = primarySchoolGraduatingClassANotifier.currentPrimarySchoolGraduatingClassA.favSubject;
    _favSchoolActivity = primarySchoolGraduatingClassANotifier.currentPrimarySchoolGraduatingClassA.favSchoolActivity;
    _favClassmate = primarySchoolGraduatingClassANotifier.currentPrimarySchoolGraduatingClassA.favClassmate;
    _favPlaceInCampus = primarySchoolGraduatingClassANotifier.currentPrimarySchoolGraduatingClassA.favPlaceInCampus;
    _favTVStation = primarySchoolGraduatingClassANotifier.currentPrimarySchoolGraduatingClassA.favTVStation;
    _favCartoon = primarySchoolGraduatingClassANotifier.currentPrimarySchoolGraduatingClassA.favCartoon;
    _worstMoment = primarySchoolGraduatingClassANotifier.currentPrimarySchoolGraduatingClassA.worstMoment;

...
class MyPrimarySchoolGraduatingClassBSearch extends SearchDelegate {

  final List all;

  bool _isVisible = true;

  MyPrimarySchoolGraduatingClassBSearch({@required this.all});
  ...
  Future navigateToPrimarySchoolGraduatingClassBDetailsPage(context) async {
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((primarySchoolGraduatingClassB) => primarySchoolGraduatingClassB.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((primarySchoolGraduatingClassB) => primarySchoolGraduatingClassB.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          primarySchoolGraduatingClassBNotifier.currentPrimarySchoolGraduatingClassB = search[position];
                          navigateToPrimarySchoolGraduatingClassBDetailsPage(context);
                        },

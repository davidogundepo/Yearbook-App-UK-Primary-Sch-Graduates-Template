...
Color modalBackgroundColor = Color.fromRGBO(216, 172, 156, 1);
...
Color dialogBackgroundColor = Color.fromRGBO(216, 172, 156, 1);
Color borderColor = Colors.black;
Color textHighlightColor = Colors.white;

var queryTech;

class MyPrimarySchoolGraduatingClassASearch extends SearchDelegate {

  final List all;

  bool _isVisible = true;

  MyPrimarySchoolGraduatingClassASearch({@required this.all});
  ...
  Future navigateToPrimarySchoolGraduatingClassADetailsPage(context) async {
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((primarySchoolGraduatingClassA) => primarySchoolGraduatingClassA.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((primarySchoolGraduatingClassA) => primarySchoolGraduatingClassA.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          primarySchoolGraduatingClassANotifier.currentPrimarySchoolGraduatingClassA = search[position];
                          navigateToPrimarySchoolGraduatingClassADetailsPage(context);
                        },
